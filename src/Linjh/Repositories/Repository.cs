...
using Linjh.Models;
using Linjh.Repositories.IRepositories;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Linq.Expressions;

namespace Linjh.Repositories
{
    /// <summary>
    /// 仓储基类
    /// </summary>
    ...
    {
        //定义数据访问上下文对象
        protected readonly LinDbcontext _dbContext;

        /// <summary>
        /// 通过构造函数注入得到数据上下文对象实例
        /// </summary>
        /// <param name="dbContext"></param>
        public Repository(LinDbcontext dbContext)
        {
    ...
    {
        public Repository(LinDbcontext dbContext) : base(dbContext)
        {
        }
    }
}
